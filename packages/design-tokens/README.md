...
2. **Export Phase**: Automated headless export via the penpot-export service defined in `infra/containers/devcontainer/docker-compose.yml` (mounting `tools/penpot-export/`)
