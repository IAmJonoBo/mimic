...
export default component$(() => {
  return (
    ...
    >
      ...
      >
        <p>
          This page demonstrates Qwik City's prefetching capabilities with <code>prefetch={true}</code> on navigation links, ensuring instant route transitions while maintaining design token consistency.
        </p>
      </div>
    </div>
  );
