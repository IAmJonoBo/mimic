...
export const TokenDemo = component$(() => {
  return (
    <div class={card}>
      ...
      <p class={text}>
        This component demonstrates the design token pipeline integration with Qwik City and Vanilla Extract, following
        the architecture documented in the USER_GUIDE.md.
      </p>
